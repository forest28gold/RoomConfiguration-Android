...
//		gl.glDisableClientState(GL10.GL_TEXTURE_COORD_ARRAY);
		...
		gl.glBindTexture(GL10.GL_TEXTURE_2D, ((PLTexture)this.getTextures().get(0)).getTextureId(gl));

		gl.glDrawArrays(GL10.GL_TRIANGLE_STRIP, 0, 4);

		GLUquadric mQuadric = GLUES.gluNewQuadric();
		GLUES.gluQuadricNormals(mQuadric, GLUES.GLU_SMOOTH);
		GLUES.gluQuadricTexture(mQuadric, true);
		GLUES.gluSphere(gl, mQuadric, PLConstants.kPanoramaRadius, PLConstants.kDefaultSphereDivs, PLConstants.kDefaultSphereDivs);
